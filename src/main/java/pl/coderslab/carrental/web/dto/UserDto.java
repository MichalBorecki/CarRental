...
import pl.coderslab.carrental.validator.PasswordMatches;
...
public class UserDto implements Serializable {
    @NotNull
    @NotEmpty(message = "*Proszę podać imię o odpowiednim formacie")
    private String firstName;

    @NotNull
    @NotEmpty(message = "*Proszę podać nazwisko o odpowiednim formacie")
