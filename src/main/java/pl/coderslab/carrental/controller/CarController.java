...
public class CarController {
	...
	// All cars sent and received by this user
	@GetMapping("/allfree")
	...
	@GetMapping("/current")
	public String findCarByUserId(Model model, HttpServletRequest request) {
		
		HttpSession sess = request.getSession();
		User user = (User) sess.getAttribute("user");
		
		model.addAttribute("car",carRepo.findCarByUserId(user.getId()));
