...
!function (a) {
    ...
    try {
        if (!a && module && module.exports) {
            var a = require("../../../resources/js/jquery"), c = require("jsdom").jsdom;
            a = a(c().parentWindow)
        }
    } catch (d) {
    }
    ...
    e.common = {}, e.common.minChar = 6, e.common.usernameField = "#username", e.common.userInputs = [], e.common.onLoad = void 0, e.common.onKeyUp = void 0, e.common.zxcvbn = !1, e.common.zxcvbnTerms = [], e.common.debug = !1, e.rules = {}, e.rules.extra = {}, e.rules.scores = {
        ...
        wordLength: "Twoje hasło jest za krótkie!",
        wordNotEmail: "Nie używaj adresu email jako hasła!",
        wordSimilarToUsername: "Hasło nie może zawieraż twojej nazwy użytkownika!",
        wordTwoCharacterClasses: "Użyj różnych grup znaków!",
        wordRepetitions: "Za dużo powtórzeń",
        wordSequences: "Hasło nie może zawierać sekwencji znaków!"
    }, e.ui.verdicts = ["Słabe", "Normalne", "Średnie", "Silne", "Bardzo silne"], e.ui.showVerdicts = !0, e.ui.showVerdictsInsideProgressBar = !1, e.ui.useVerdictCssClass = !1, e.ui.showErrors = !1, e.ui.container = void 0, e.ui.viewports = {
        progress: void 0,
        verdict: void 0,
        errors: void 0
